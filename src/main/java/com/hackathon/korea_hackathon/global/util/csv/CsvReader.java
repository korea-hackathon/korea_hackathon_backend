...
public class CsvReader {
    ...
    public FlatFileItemReader<ShipLogDTO> csvScheduleReader(){
        ...
        flatFileItemReader.setResource(new ClassPathResource("file/csv/FL_insurance_sample.csv")); //읽을 파일 경로 지정
        ...
        delimitedLineTokenizer.setNames("policyID", "statecode", "county"); //행으로 읽은 데이터 매칭할 데이터 각 이름
